...
const eventCatalog: Record<number, {
  id: number;
  title: string;
  artist: string;
  tour: string;
...
function EventDetailContent() {
  ...
  return (
    <div className="bg-black min-h-screen pb-24 relative">
      ...
      <div className="flex items-center justify-center gap-2 px-4 py-3" style={{ backgroundColor: '#026CDF' }}>
      ...
      <div className="mx-4 mt-4 rounded-xl overflow-hidden border border-white/10">
        ...
        <div className="flex items-center justify-around py-3 bg-white/5 border-t border-white/10">
          ...
          <button className="flex flex-col items-center gap-1 w-16">
            <svg className="w-6 h-6 text-[#026CDF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7h12m0 0l-4-4m4 4l-4 4m-4-4v12" />
            </svg>
